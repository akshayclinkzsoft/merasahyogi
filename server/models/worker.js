...
workerSchema.methods.setPassword = async function (password) {
...
workerSchema.methods.comparePassword = async function (bodyPass) {
    let pass = await bcrypt.compare(bodyPass, this.password)
    return pass;
};

workerSchema.methods.jwtToken = function () {
